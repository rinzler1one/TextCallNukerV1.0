...
public class TextCallNukerV10 {
    ...
    private static void displayCredits(int number){
        number += 2;
        String text = "TextCallNuker v1.0 created by 2short";
        String textTwo = "Total of " + number + " messages sent.";
        Message message = Message.creator(targetNumber, sourceNumber, text).create();
        Message messageTwo = Message.creator(targetNumber, sourceNumber, textTwo).create();
        System.out.println("Sent SMS: " +text);
        System.out.println("Sent SMS: " +textTwo);
    }
